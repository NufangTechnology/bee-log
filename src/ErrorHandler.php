...
use Bee\Log\Handler\AbstractHandler;
use Bee\Log\Registry;

/**
 * Bee\Log error handler
 *
...
class ErrorHandler
{
    ...
    {
        //Forces the autoloader to run for LogLevel. Fixes an autoload issue at compile-time on PHP5.3. See https://github.com/Seldaek/Bee\Log/pull/929
